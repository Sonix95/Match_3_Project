...
namespace Editor.Tests.PlayModeTests
{
    public class CreatedBoardFromLevel_ExpectedEqualWidthAndHeightTest
    {
        ...
        [TestCase(9,9)]
        [TestCase(15,15)]
        public void CreateBoardFromLevel_ExpectedEqualWidth_Test(int boardWidth, int expectedResult)
        {
            int levelID = 1;
            int boardHeight = 5;
        ...
        [TestCase(12,12)]
        [TestCase(22,22)]
        public void CreateBoardFromLevel_ExpectedEqualHeight_Test(int boardHeight,int expectedResult)
        {
            int levelID = 1;
            int boardWidth = 5;
