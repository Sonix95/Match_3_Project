...
namespace Mathc3Project.Classes
{
    public class UIMenuManager : IUIManager
    {
        ...
        public UIMenuManager(INavigationManager navigationManager, ILevelsManager levelsManager)
        {
        ...
        public void OnEvent(EventTypes eventType, object messageData)
        {
            switch (eventType)
            {
                ...
                case EventTypes.UI_SelectLevel:
                    ILevel selectedLevel = _levelsManager.Levels[_chosenLevel];
